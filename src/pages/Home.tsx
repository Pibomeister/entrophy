  ...
  const eventTypes = [
    {
      ...
      title: 'Bodas',
      description:
        'Mesas de dulces elegantes y románticas para tu día especial',
    },
    {
      icon: Cake,
      title: 'XV Años',
      description: 'Diseños únicos que complementan la temática de tu fiesta',
    },
    {
      icon: Award,
      title: 'Corporativos',
      description: 'Presentaciones profesionales para eventos empresariales',
    },
    {
      icon: Music,
      title: 'Fiestas',
      description: 'Opciones divertidas para celebraciones y reuniones',
    },
    {
      icon: Camera,
      title: 'Graduaciones',
      description: 'Montajes especiales para momentos académicos',
    },
    {
      icon: Coffee,
      title: 'Eventos Sociales',
      description: 'Soluciones dulces para cualquier tipo de reunión',
    },
  ];
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              Mesitas de Dulces para Eventos Inolvidables
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-white text-opacity-90">
              Creamos experiencias dulces personalizadas para bodas, XV años,
              eventos corporativos y todo tipo de celebraciones en México.
            </p>
            ...
            {[
              {
                ...
                desc: 'Adaptamos cada detalle al estilo y temática de tu evento para crear una experiencia única.',
              },
              {
                bg: 'purple',
                icon: Sparkles,
                title: 'Calidad Premium',
                desc: 'Utilizamos productos de la más alta calidad y presentaciones elegantes para impresionar a tus invitados.',
              },
              {
                bg: 'yellow',
                icon: Clock,
                title: 'Montaje Puntual',
                desc: 'Nos encargamos de todo el montaje y desmontaje para que tú solo te preocupes por disfrutar.',
              },
              {
                bg: 'blue',
                icon: Star,
                title: 'Experiencia Comprobada',
                desc: 'Más de 500 eventos realizados y cientos de clientes satisfechos nos respaldan.',
              },
            ].map((feature, index) => (
              <motion.div
                key={index}
              ...
              >
                <div
                  className={`w-16 h-16 mx-auto bg-${feature.bg}-500 text-white rounded-full flex items-center justify-center mb-4`}
                >
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
              Creamos mesas de dulces perfectas para cualquier ocasión especial.
              Cada evento merece una presentación única.
            </p>
          </motion.div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
              Nuestro proceso está diseñado para hacer tu experiencia fácil y
              sin complicaciones.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                desc: 'Discutimos tus ideas y requerimientos para el evento',
              },
              {
                step: '2',
                title: 'Diseño Personalizado',
                desc: 'Creamos una propuesta única para tu evento',
              },
              {
                step: '3',
                title: 'Confirmación',
                desc: 'Ajustamos los detalles finales y confirmamos la reserva',
              },
              {
                step: '4',
                title: 'Entrega',
                desc: 'Montamos todo en tu evento y nos encargamos de cada detalle',
              },
            ].map((step, index) => (
              <motion.div
                key={index}
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-600 text-center mb-10 max-w-2xl mx-auto">
              Explora nuestras mesas de dulces en eventos reales y déjate
              inspirar para tu próxima celebración.
            </p>
          </motion.div>
            ...
            {[
              ...
              >
                ...
                <div className="flex items-center">
                  <div
                    className={`w-10 h-10 bg-${testimonial.color}-100 rounded-full flex items-center justify-center text-${testimonial.color}-500 font-bold mr-3`}
                  >
      ...
      <section className="py-20 bg-gradient-to-r from-pink-500 to-purple-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            >
              Contáctanos hoy para una asesoría personalizada y haz que tu
              evento sea inolvidable con nuestras mesas de dulces.
            </motion.p>
            <motion.div
              variants={fadeInUp}
